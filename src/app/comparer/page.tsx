...
import { CheckCircle2, XCircle, Scale, ArrowLeft, ArrowRight, ShoppingCart } from "lucide-react";
...
function CompareContent() {
  ...
  const rows: { labelFr: string; labelAr: string; key: string; getValue: (l: typeof listings[0]) => string | null }[] = [
    ...
    ...allAttrKeys.map((k) => ({
      ...
      getValue: (l: typeof listings[0]) => l.attributes?.[k] ?? null,
    })),
  ];
