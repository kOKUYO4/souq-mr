...
const sections = {
  fr: [
    { title: "1. Acceptation des conditions", content: "En utilisant SOUQ.MR, vous acceptez les présentes CGU. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser notre service. SOUQ.MR se réserve le droit de modifier ces conditions à tout moment avec notification sur la plateforme." },
    { title: "2. Description du service", content: "SOUQ.MR est une plateforme de petites annonces permettant aux utilisateurs mauritaniens d'acheter, vendre et échanger biens et services. SOUQ.MR agit comme intermédiaire et n'est pas partie aux transactions, sauf dans le cadre du service Escrow." },
    ...
    { title: "4. Publication d'annonces", content: "Seuls les biens légaux peuvent être publiés. Sont interdits : armes, drogues, contrefaçons, contenus illicites. Chaque annonce est modérée sous 2h. SOUQ.MR peut supprimer toute annonce sans préavis." },
    ...
    { title: "6. Responsabilité", content: "SOUQ.MR ne garantit pas l'exactitude des informations des vendeurs. En cas d'arnaque signalée, SOUQ.MR répond sous 1h ouvrée et assiste les parties." },
    { title: "7. Propriété intellectuelle", content: "Tous les contenus de SOUQ.MR sont protégés. Toute reproduction sans autorisation est interdite. Les utilisateurs conservent leurs droits sur leurs publications et accordent à SOUQ.MR une licence d'affichage." },
    ...
    { title: "10. Contact légal", content: "legal@souq.mr | SOUQ.MR SARL, Tevragh-Zeina, Nouakchott, Mauritanie | +222 XX XX XX XX" },
  ],
  ar: [
    { title: "1. قبول الشروط", content: "باستخدام سوق.مر فإنك تقبل شروط الاستخدام. إذا كنت لا توافق، يُرجى عدم استخدام الخدمة. تحتفظ سوق.مر بحق التعديل مع إشعار على المنصة." },
    { title: "2. وصف الخدمة", content: "سوق.مر منصة إعلانات مبوبة للمستخدمين الموريتانيين. تعمل كوسيط فقط ولا تكون طرفاً في المعاملات إلا في إطار خدمة الضمان المالي." },
    ...
    { title: "4. نشر الإعلانات", content: "السلع القانونية فقط. يُحظر: الأسلحة والمخدرات والمنتجات المقلدة. كل إعلان يُراجع خلال ساعتين. يحق لسوق.مر حذف أي إعلان دون إشعار." },
    ...
    { title: "6. المسؤولية", content: "لا تضمن سوق.مر دقة معلومات البائعين. عند الإبلاغ عن احتيال، ترد سوق.مر خلال ساعة عمل وتساعد الأطراف." },
    { title: "7. الملكية الفكرية", content: "جميع محتويات سوق.مر محمية. يُحظر الاستنساخ دون إذن. يحتفظ المستخدمون بحقوق منشوراتهم ويمنحون ترخيص عرض لسوق.مر." },
    ...
    { title: "10. التواصل القانوني", content: "legal@souq.mr | سوق.مر ش.م.ر، تيفرغ زينة، نواكشوط، موريتانيا | +222 XX XX XX XX" },
  ],
};
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-3">
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 text-sm text-amber-700 mb-6">
          <p className={isRTL ? "font-arabic text-right" : ""}>
            {isRTL ? "يُرجى قراءة هذه الشروط بعناية قبل استخدام منصة سوق.مر." : "Veuillez lire attentivement ces conditions avant d'utiliser SOUQ.MR."}
          </p>
        </div>
        ...
        <div className="bg-night-500 rounded-2xl p-5 text-center mt-4">
          <p className={`text-sand-300/70 text-sm ${isRTL ? "font-arabic" : ""}`}>
            {isRTL ? "أسئلة؟ تواصل معنا: " : "Questions ? "}<a href="mailto:legal@souq.mr" className="text-sand-400 font-semibold">legal@souq.mr</a>
          </p>
        </div>
      </div>
    </div>
